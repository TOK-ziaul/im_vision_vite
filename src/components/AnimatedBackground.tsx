  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 20% 50%, rgba(43, 204, 7, 0.03) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(43, 204, 7, 0.02) 0%, transparent 50%)',
        }}
      />
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(43, 204, 7, 0.08) 0%, transparent 70%)',
          filter: 'blur(60px)',
          top: '10%',
          left: '10%',
        }}
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(43, 204, 7, 0.06) 0%, transparent 70%)',
          filter: 'blur(70px)',
          top: '50%',
          right: '10%',
        }}
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(43, 204, 7, 0.05) 0%, transparent 70%)',
          filter: 'blur(50px)',
          bottom: '20%',
          left: '30%',
        }}
