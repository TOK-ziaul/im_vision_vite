      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.key}>
                  <button
                    className="text-white/60 hover:text-[#2BCC07] transition-colors duration-300"
                    style={{
                      fontSize: '0.95rem',
                      fontWeight: 300,
                    }}
          ...
          <div>
            ...
            <div className="flex gap-4">
              <button className="w-10 h-10 border border-white/20 hover:border-[#2BCC07] hover:bg-[#2BCC07]/10 flex items-center justify-center transition-all duration-300">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <button
              className="text-white/40 hover:text-[#2BCC07] transition-colors duration-300"
              style={{
                fontSize: '0.85rem',
                fontWeight: 300,
              }}
