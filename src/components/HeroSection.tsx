...
export function HeroSection({ heroImage }: HeroSectionProps) {
  ...
  return (
    <section ref={ref} className="relative h-screen w-full overflow-hidden" style={{ position: 'relative' }}>
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-6 lg:px-12 pt-32 md:pt-40 lg:pt-48 pb-48 md:pb-56 lg:pb-64">
        ...
        >
          ...
          <div className="mb-6 relative w-full flex items-center justify-center" style={{ minHeight: 'min(35vh, 400px)' }}>
          ...
          >
            <span style={{ fontWeight: 600 }}>High-impact</span> LED display solutions
          </motion.p>
