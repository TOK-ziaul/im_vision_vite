            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <option value="+93" className="bg-black text-white">+93</option>
                    ...
                    <option value="+53" className="bg-black text-white">+53</option>
                    ...
                    <option value="+36" className="bg-black text-white">+36</option>
                    <option value="+354" className="bg-black text-white">+354</option>
                    <option value="+91" className="bg-black text-white">+91</option>
                    <option value="+62" className="bg-black text-white">+62</option>
                    <option value="+98" className="bg-black text-white">+98</option>
                    ...
                    <option value="+60" className="bg-black text-white">+60</option>
                    ...
                    <option value="+95" className="bg-black text-white">+95</option>
                    ...
                    <option value="+63" className="bg-black text-white">+63</option>
                    <option value="+48" className="bg-black text-white">+48</option>
                    ...
                    <option value="+65" className="bg-black text-white">+65</option>
                    ...
                    <option value="+211" className="bg-black text-white">+211</option>
                    <option value="+34" className="bg-black text-white">+34</option>
                    <option value="+94" className="bg-black text-white">+94</option>
                    ...
                    <option value="+66" className="bg-black text-white">+66</option>
                    ...
                    <option value="+90" className="bg-black text-white">+90</option>
                    ...
                    <option value="+58" className="bg-black text-white">+58</option>
                    <option value="+84" className="bg-black text-white">+84</option>
              ...
              <div className="flex items-start gap-3 pt-2">
                ...
                >
                  By submitting this form, you agree to your data being stored. Of course, we will not keep them longer than necessary and will treat them with care and confidentiality.
                </label>
              </div>
              ...
              <div className="pt-4">
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: '0 0 20px rgba(43, 204, 7, 0.1), inset 0 0 20px rgba(43, 204, 7, 0.05)',
                  }}
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      background: 'linear-gradient(90deg, transparent, rgba(43, 204, 7, 0.3), transparent)',
                      width: '30%',
                    }}
                    animate={{
                      x: ['-100%', '400%'],
                  ...
                  <motion.div
                    ...
                    style={{
                      boxShadow: '0 0 40px rgba(43, 204, 7, 0.3), inset 0 0 40px rgba(43, 204, 7, 0.1)',
                    }}
                  />
                </motion.button>
              </div>
