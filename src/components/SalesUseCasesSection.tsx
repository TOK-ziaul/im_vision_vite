...
const useCases: UseCase[] = [
  {
    ...
    description: 'Transform traditional retail spaces into immersive brand experiences where customers can interact with products through dynamic LED displays, creating memorable shopping journeys that blend physical and digital touchpoints.',
  ...
  },
  {
    ...
    description: 'Elevate workplace environments with large-format LED installations that facilitate collaboration, display real-time data, and create inspiring spaces where teams connect and innovate together.',
  ...
  },
  {
    ...
    description: 'Create captivating atmospheres in hotels, restaurants, and entertainment spaces with immersive LED environments that adapt to events, enhance guest experiences, and tell compelling brand stories.',
  ...
  },
  {
    ...
    description: 'Turn buildings into dynamic canvases with exterior LED installations that transform urban landscapes, create iconic landmarks, and engage communities through large-scale digital art and messaging.',
    ...
    >
      ...
      >
        ...
        <div className="relative aspect-[16/9] overflow-hidden">
          ...
          {/* Arrow Icon */}
          <motion.div
            className="absolute top-8 right-8 w-12 h-12 border-2 border-white/30 group-hover:border-[#2BCC07] group-hover:bg-[#2BCC07] flex items-center justify-center transition-all duration-500 opacity-0 group-hover:opacity-100"
          >
...
export function SalesUseCasesSection() {
  ...
  return (
    <div ref={sectionRef} className="relative bg-black py-20 lg:py-32">
      {/* Green border */}
      ...
      <div className="container mx-auto px-6 lg:px-24">
        ...
        >
          ...
          >
            New <span className="text-[#2BCC07]">phygital use cases</span> for LED display solutions
          </h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full h-[1px] bg-gradient-to-r from-transparent via-[#2BCC07] to-transparent mt-20 lg:mt-32 origin-center"
        />
      </div>
    </div>
  );
