    ...
    <div className="relative bg-black">
      ...
      <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1760463921642-eef64776c3bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncm9jZXJ5JTIwc3RvcmUlMjBpbnRlcmlvciUyMG1vZGVybnxlbnwxfHx8fDE3NzAyMTYzNTJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
        ...
        <div className="relative z-10 max-w-7xl px-8 text-center">
          ...
          <div className="mb-20">
            ...
            >
              <span className="text-[#2BCC07]">Shopping Experience</span>
            </motion.h1>
          </div>
          ...
          >
            ...
            >
              A leading grocery chain turned to us to upgrade its stores with digital solutions 
              that improve the customer experience and highlight the store's offerings.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-6xl px-8 text-center">
          ...
          >
            ...
            >
              Our client, a well-known fashion chain, wanted to modernize their in-store experience. 
              With operations in multiple cities, they sought to increase customer engagement and 
              strengthen brand presence through innovative digital solutions.
            </p>
          </motion.div>
        </div>
      </div>

      {/* Section 3: Window Displays Solution */}
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex">
          ...
          >
            <ImageWithFallback
              src="https://images.unsplash.com/photo-1719528809959-082f7e5c2f8b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncm9jZXJ5JTIwc3RvcmUlMjBMRUQlMjBkaWdpdGFsJTIwc2lnbmFnZSUyMGRpc3BsYXl8ZW58MXx8fHwxNzcwMjMwMTI5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          ...
          >
            <div className="max-w-2xl px-12">
              ...
              >
                We installed high-resolution LED screens in the store windows to display seasonal 
                promotions, trends and new collections, transforming static displays into dynamic 
                visual experiences that captivate passersby.
              </motion.p>
      ...
      {/* Section 4: Checkout Experience - Split Layout */}
      <div className="relative h-screen w-full">
        <div className="grid lg:grid-cols-2 h-full">
          ...
          >
            <div className="max-w-xl">
              ...
              >
                A larger LED screen was placed at the checkout to provide customers with personalized 
                recommendations and create a more engaging shopping experience.
              </motion.p>
            </div>
          </motion.div>
          ...
          >
            <ImageWithFallback
              src="https://images.unsplash.com/photo-1683840567064-e430df9f5ed6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncm9jZXJ5JTIwc3RvcmUlMjBjaGVja291dCUyMGNvdW50ZXIlMjBtb2Rlcm58ZW58MXx8fHwxNzcwMjMwMzYyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
        ...
        <div className="relative px-6 lg:px-12">
          ...
          <div className="sticky top-24 mb-8">
            ...
            >
              ...
              <div className="relative p-8 lg:p-12">
                ...
                >
                  Drawing more people into stores through captivating digital displays that showcase dynamic content and seasonal promotions.
                </motion.p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="sticky top-24 mb-8">
            ...
            >
              ...
              <div className="relative h-64 lg:h-80 overflow-hidden">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1760463921956-b21cfa5cb2ac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdXBlcm1hcmtldCUyMGFpc2xlJTIwZnJlc2glMjBwcm9kdWNlfGVufDF8fHx8MTc3MDIzMDM2Mnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              ...
              <div className="relative p-8 lg:p-12">
                ...
                >
                  Strengthen brand <span className="text-[#2BCC07]">presence</span>
                </motion.h3>
                ...
                >
                  Reinforcing identity with consistent, high-impact visual messaging across all store locations.
                </motion.p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="sticky top-24 mb-8">
            ...
            >
              ...
              <div className="relative h-64 lg:h-80 overflow-hidden">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1764795850248-97a5e986b242?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjByZXRhaWwlMjBzdG9yZSUyMGludGVyaW9yJTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NzAyMzAzNjN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              ...
              <div className="relative p-8 lg:p-12">
                ...
                >
                  Create modern <span className="text-[#2BCC07]">interactive</span> experiences
                </motion.h3>
                ...
                >
                  Engaging customers with cutting-edge technology and personalized content that creates memorable shopping moments and drives brand loyalty.
                </motion.p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-3 gap-12 lg:gap-16 mb-20">
            ...
            >
              <div className="relative border-l-2 border-[#2BCC07] pl-8 lg:pl-12">
                ...
                <div className="relative">
                  ...
                  >
                    Significant growth in foot traffic and in-store interactions within the first three months of deployment.
                  </motion.p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                Doubled online engagement through shareable in-store experiences.
              </motion.p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        >
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1562070416-acfd0b43db97?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncm9jZXJ5JTIwc3RvcmUlMjBlbnRyYW5jZSUyMGN1c3RvbWVycyUyMHNob3BwaW5nfGVufDF8fHx8MTc3MDIzMDM2Mnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
            alt="Contact us"
            className="w-full h-full object-cover"
          />
