...
const portfolioItems: Portfolio[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80',
    size: 'wide',
  },
  {
    id: 6,
    ...
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80',
    size: 'medium',
  },
  {
    id: 7,
    ...
    category: 'Sports',
    image: 'https://images.unsplash.com/photo-1508766206392-8bd5cf550d1c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80',
    size: 'large',
  },
  {
    id: 8,
    ...
    category: 'Cultural',
    image: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80',
    size: 'small',
  },
  {
    id: 9,
    ...
    category: 'Retail',
    image: 'https://images.unsplash.com/photo-1555421689-d68471e189f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80',
    size: 'wide',
  },
  {
    id: 10,
    ...
    category: 'Corporate',
    image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80',
    size: 'medium',
  },
];
...
export function SalesDisplaySolutionsSection() {
  ...
  return (
    <div ref={sectionRef} className="relative bg-black overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <motion.div style={{ y: descY }}>
              ...
              >
                Our display solutions strengthen your brand, improve customer experience and contribute to effective communication. Whether it's about attracting customers in stores, streamlining information in public environments or improving workflows in corporate environments, we offer the right solution.
              </motion.p>
      ...
      <div ref={scrollSectionRef} className="relative py-20 lg:py-32 min-h-screen">
