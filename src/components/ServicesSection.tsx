...
const services: Service[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1761618291331-535983ae4296?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbmdpbmVlcmluZyUyMGRlc2lnbiUyMExFRCUyMHRlY2hub2xvZ3klMjBwbGFubmluZ3xlbnwxfHx8fDE3NzA2MzExMDF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    id: 2,
    number: '02',
    title: 'Installation and Roll-out',
    description: 'Our services and proven methods are designed to plan, install, and roll out LED screens in a smart, sustainable, and efficient way. We combine in-house installation experts with a global network of skilled and flexible engineers. With smart pre-production in our central warehouse and custom-built support apps, we ensure high-quality and consistent installations. Careful planning is key to a successful roll-out, which is why we give this phase our full attention—not only to make sure technicians are fully prepared and equipped, but also to reduce disruption to your operations. Using our in-house Smart Deployment methodology, we pre-assemble key components at our warehouse and deliver them ready to go, with minimal packaging and on-site work. This way, your LED screen installation is completed with maximum efficiency and long-term reliability.',
    features: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1768483538267-fce52de424d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2Z0d2FyZSUyMG1hbmFnZW1lbnQlMjBkYXNoYm9hcmQlMjB0ZWNobm9sb2d5fGVufDF8fHx8MTc3MDYzMTAwMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    id: 5,
    number: '05',
    title: 'LED Configurator',
    description: 'Once the concept and strategy for your challenge have been formed, we embark on building a digital signage solution. This is where solutions design and integration come together. During the creative strategy process, our solutions architects analyze how the ideas can be realized and then get to work on pre-engineering. Next, we determine the best combination of hardware and software.',
    features: [
    ...
    image: 'https://images.unsplash.com/photo-1690964099658-b619682704ce?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwc2lnbmFnZSUyMExFRCUyMGNvbmZpZ3VyYXRvciUyMHNjcmVlbnxlbnwxfHx8fDE3NzA2MzEwMDF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
];
